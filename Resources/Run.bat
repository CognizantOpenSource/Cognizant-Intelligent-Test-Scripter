...
IF "%~1" == "" (
start javaw -Xms128m -Xmx1024m -Dfile.encoding=UTF-8 -cp cognizant-intelligent-test-scripter-ide-${project.version}.jar;%APP_CLASSPATH%; com.cognizant.cognizantits.ide.main.Main %*
) ELSE (
