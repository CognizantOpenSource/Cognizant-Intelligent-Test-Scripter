 ...
 */
package com.cognizant.cognizantits.engine.drivers.findObjectBy.support;
...
public class ByObjectProp {
    ...
    public static void load() {
        if (byObjectProp.OBJ_PROP_CLASSES.isEmpty()) {
            AnnontationUtil.detect(ANNOTATION_DETECTOR, "com.cognizant.cognizantits.engine.drivers.findObjectBy");
        }
    }
