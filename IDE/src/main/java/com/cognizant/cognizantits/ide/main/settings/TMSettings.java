...
import com.cognizant.cognizantits.datalib.settings.TestMgmtModule;
...
public class TMSettings extends javax.swing.JFrame {
    ...
    public TMSettings(AppMainFrame sMainFrame) {
        ...
        initComponents();
        setIconImage(((ImageIcon) Utils.getIconByResourceName("/ui/resources/main/TestManagementConfiguration")).getImage());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Test Management Configuration");
        ...
        moduleCombo.setPreferredSize(new java.awt.Dimension(150, 26));
