 ...
 */
package com.cognizant.cognizantits.ide.main.mainui.components.testexecution.tree;
...
import com.cognizant.cognizantits.ide.main.mainui.components.testexecution.tree.model.ReleaseNode;
import com.cognizant.cognizantits.ide.main.mainui.components.testexecution.tree.model.TestLabModel;
    ...
    private void getCmdLineSyntax() {
        ...
        if (testSet != null) {
            ...
            String syntax = String.format(
                    "Run.bat -run -project_location \"%s\" -release \"%s\" -testset \"%s\"",
