...
//        }
    ...
    private void initComponents() {
        ...
        configProxy = new javax.swing.JButton();
        ...
        defaultAppium = new javax.swing.JButton();
        ...
        setPreferredSize(new java.awt.Dimension(462, 550));
        ...
        configProxy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/resources/toolbar/proxy.png"))); // NOI18N
        configProxy.setToolTipText("Configure Proxy");
        configProxy.setFocusable(false);
        configProxy.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        configProxy.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        configProxy.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                configProxyActionPerformed(evt);
            }
        });
        jToolBar1.add(configProxy);
        ...
        mainTab.addTab("General", commonPanel);
        ...
        jLabel2.setText("Browser/Emulator");
        ...
        editEmulator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/resources/toolbar/editIcon.png"))); // NOI18N
        editEmulator.setToolTipText("Rename Emulator");
        editEmulator.setFocusable(false);
        ...
        deleteEmulator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/resources/toolbar/deleteIcon.png"))); // NOI18N
        deleteEmulator.setToolTipText("Remove Emulator");
        deleteEmulator.setFocusable(false);
        ...
        defaultAppium.setText("Default Appium");
        defaultAppium.setFocusable(false);
        defaultAppium.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        defaultAppium.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        defaultAppium.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                defaultAppiumActionPerformed(evt);
            }
        });
        jToolBar2.add(defaultAppium);
        ...
        emCapTab.addTab("Capabilities", capabilityPanel);
    ...
    private void addNewEmulatorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewEmulatorActionPerformed
        addNewEmulator();
    }//GEN-LAST:event_addNewEmulatorActionPerformed
    ...
    private void defaultAppiumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_defaultAppiumActionPerformed
        String selBrowser = browserCombo.getSelectedItem().toString();
        Emulator emulator = settings.getEmulators().getEmulator(selBrowser);
        if (emulator != null) {
            settings.getCapabilities().addDefaultAppiumCapability(selBrowser);
            loadCapabilities(selBrowser);
        }
    }//GEN-LAST:event_defaultAppiumActionPerformed
    ...
    private javax.swing.JButton configProxy;
    private javax.swing.ButtonGroup customDeviceGroup;
    private javax.swing.JButton defaultAppium;
